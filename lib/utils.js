...
/**
 * Converts an ISO date string into a human-readable "time ago" format.
 *
 * Examples:
 * - "5 minutes ago"
 * - "3 weeks ago"
 ...
 * - "just now"
 *
 * @param {string} isoDateString - The ISO 8601 date string to compare against the current time.
